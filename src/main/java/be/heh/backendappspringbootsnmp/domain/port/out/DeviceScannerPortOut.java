...
public interface DeviceScannerPortOut {
    ...
    public MachineEntity getAllInfoOfMachineEntity(MachineEntity machineEntity,List<String> ipAddress) throws NMapExecutionException, NMapInitializationException;
}
